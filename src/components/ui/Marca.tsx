...
export function SimboloMarca({ tamanho = 32 }: { tamanho?: number }) {
  return (
    <svg width={tamanho} height={tamanho} viewBox="0 0 32 32" aria-hidden="true" className="shrink-0">
      <rect width="32" height="32" rx="8" fill="var(--color-trena)" />
      <path d="M9 24.5 16 7.5l7 17" fill="none" stroke="var(--color-trena-tinta)" strokeWidth="3.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M11.2 19h9.6" stroke="var(--color-trena-tinta)" strokeWidth="2.4" strokeLinecap="round" />
      <path d="M13.6 19v-2M16 19v-2.8M18.4 19v-2" stroke="var(--color-trena-tinta)" strokeWidth="1.4" strokeLinecap="round" />
      <circle cx="25.2" cy="24.4" r="2.2" fill="var(--color-acao)" />
    </svg>
  );
}

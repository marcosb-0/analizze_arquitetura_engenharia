...
export default function ConsumoInsumos({ projetoId, recarregarEm }: ConsumoInsumosProps) {
  ...
  if (carregando) {
    return (
      <div className="bg-superficie rounded-lg border border-slate-200 shadow-sm p-6 flex justify-center">
        <Spinner size={18} />
      </div>
    );
  }
  ...
  return (
    <div className="bg-superficie rounded-lg border border-slate-200 shadow-sm overflow-hidden">
